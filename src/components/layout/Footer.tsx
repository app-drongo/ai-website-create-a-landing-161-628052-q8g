  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Data Migration', href: '/templates' },
        { name: 'Custom Modules', href: '/integrations' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Training Programs', href: '/tutorials' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'SAP Certification', href: '/compliance' },
      ],
    },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Transforming businesses through seamless SAP ERP integration. Trusted by 500+
                enterprises worldwide for mission-critical implementations.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Weekly SAP updates, best practices, and implementation tips.
              </p>
            </div>
          </div>
